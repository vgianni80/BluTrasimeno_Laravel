...
<?php $component->withAttributes([]); ?>
    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            ...
            <!-- Dati Finanziari -->
            <?php if($booking->paid_by_guest !== null): ?>
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="fw-bold">€ <?php echo e(number_format($booking->paid_by_guest, 2, ',', '.')); ?></div>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="text-muted small">Pagato al proprietario (Payout)</label>
                            <div class="fw-bold">€ <?php echo e(number_format($booking->home_owner_payout, 2, ',', '.')); ?></div>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="text-muted small">Commissione OTA</label>
                            <div>€ <?php echo e(number_format($booking->channel_commission, 2, ',', '.')); ?></div>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="text-muted small">Commissione Holidu (Bookiply)</label>
                            <div>€ <?php echo e(number_format($booking->bookiply_commission, 2, ',', '.')); ?></div>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="text-muted small">Spese gestione Holidu (Processing Markup)</label>
                            <div>€ <?php echo e(number_format($booking->bookiply_processing_markup, 2, ',', '.')); ?></div>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="text-muted small">IVA</label>
                            <div>€ <?php echo e(number_format($booking->vat, 2, ',', '.')); ?></div>
                        </div>
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="d-flex align-items-center gap-2">
                                <span class="fw-bold">€ <?php echo e(number_format($booking->cedolare_secca, 2, ',', '.')); ?></span>
                                <?php if($cedolareOk): ?>
                                ...
                                <?php else: ?>
                                    <span class="badge bg-warning text-dark"
                                          title="Valore atteso: € <?php echo e(number_format($cedolareAtteso, 2, ',', '.')); ?>">
                                        <i class="bi bi-exclamation-triangle"></i>
                                        atteso € <?php echo e(number_format($cedolareAtteso, 2, ',', '.')); ?>

                                    </span>
                                <?php endif; ?>
                            </div>
                        </div>
                        <?php if($booking->holidu_channel): ?>
                        <div class="col-md-6 mb-3">
                            <label class="text-muted small">Canale</label>
                            <div><?php echo e($booking->holidu_channel); ?></div>
                        </div>
                        <?php endif; ?>
                    </div>
                </div>
